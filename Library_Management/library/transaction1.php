			...
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong> Enter Faculty ID Number to Continue</strong>
					</div>
					<div class="panel-body">
						<form role="form" action="checkinfo1.php" method="POST">
							<fieldset>
								<div class="row">
									...
									<div class="col-sm-12 col-md-10  col-md-offset-1 ">
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" placeholder="Faculty ID Number" name="fac_no" type="text" autofocus>
											</div>
										</div>
