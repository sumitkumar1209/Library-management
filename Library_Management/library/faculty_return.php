...
<h3 align="center">Make Entry for returned books!</h3>
	...
	<form class="form-horizontal container" role="form" method="post" action="faculty_return_next.php">
   <div class="form-group">
      <label for="rollno" class="col-sm-2 control-label">Faculty ID</label>
      <div class="col-sm-10">
         <input type="number" class="form-control" name="faculty_id" 
            placeholder="Enter Faculty ID here...">
      </div>
   </div>
   <div class="form-group">
